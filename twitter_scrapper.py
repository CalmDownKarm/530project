...
# ht = home_team_details.TWITTER_HANDLE.values[0]
# vt = visitor_team_details.TWITTER_HANDLE.values[0]
...
# config = twint.Config
# config.To = ht
# config.Since = week_before
# config.Until = game_date
# config.Store_csv = True
# config.Stats=True
